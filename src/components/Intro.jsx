...
import { doYouWantToShowLeetCode, facebookLink, githubLink, instagramLink, leetcodeLink, linkedinLink } from '../details.js';
        ...
        <>
            ...
            <div className="relative h-smScreen lg:h-screen bg-cover bg-center overflow-hidden bg-bg2 md:bg-bg1">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                    ...
                    <div className="font-handwriting text-5xl md:text-6xl lg:text-8xl text-white mb-6 inline-block flex items-center justify-center md:px-20">
                        <TypeAnimation
        ...
        <>
            <div className="absolute left-0 transform -translate-y2-1/2 translate-y-1/ hidden md:block" >
                <div className='grid grid-cols-1 text-xl md:space-y-3 md:py-2 lg:space-y-6 lg:py-4 px-2 border border-indigo-600 rounded-r-2xl bg-white'>
                    <Reveal color='#2B02D9'>
                    <a href={linkedinLink} target="_blank" rel="noopener noreferrer" className="text-black hover:text-blue-400 ">
                        <FontAwesomeIcon icon={faLinkedin} className="md:text-3xl hover:md:text-4xl lg:text-4xl hover:lg:text-5xl duration-300"/>
                    </a>
                    </Reveal>
                    <Reveal color='#878887'>
                        <a href={githubLink} target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-600">
                            <FontAwesomeIcon icon={faGithub}  className="md:text-3xl hover:md:text-4xl lg:text-4xl hover:lg:text-5xl duration-300"/>
                        </a>
                    </Reveal>
                    {doYouWantToShowLeetCode && <Reveal color='yellow'>
                        <a href={leetcodeLink} target="_blank" rel="noopener noreferrer" className="text-black hover:text-yellow-600">
                    ...
                    <Reveal color='#4144BE'>
                        <a href={facebookLink} target="_blank" rel="noopener noreferrer" className="text-black hover:text-blue-600">
                            <FontAwesomeIcon icon={faFacebook} className="md:text-3xl hover:md:text-4xl lg:text-4xl hover:lg:text-5xl duration-300" />
                        </a>
                    </Reveal>
                    <Reveal color='#E73CCD'>
                        <a href={instagramLink} target="_blank" rel="noopener noreferrer" className="text-black hover:text-pink-400">
